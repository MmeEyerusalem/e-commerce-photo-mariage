...
' problème.');
    ...
    if(!preg_match($email_exp,$email)) {
      $message .= 'L\'adresse e-mail que vous avez entrée ne semble pas être valide.<br />';
    }
    ...
    if(!preg_match($string_exp,$nom)) {
      $message .= 'Le nom que vous avez entré ne semble pas être valide.<br />';
    }
   
    if(!preg_match($string_exp,$prenom)) {
      $message .= 'Le prénom que vous avez entré ne semble pas être valide.<br />';
    }
   
    if(strlen($commentaire) < 2) {
      $message .= 'Le commentaire que vous avez entré ne semble pas être valide.<br />';
    }
