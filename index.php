...
<div class="titreIndex"><h1 class="texte-dark">Le Jour Important...</h1></div>
    ...
    <div class="col-6 lastPara">
        <h2 class="text-center "> Les ventes sont au forfait </h2>
        <p class="fs-5 text-center">Une à deux heures de prises de vues, 100 photos seront livrées. <br> Une demi-journée, 250 photos. Une journée, 500 photos. <br> Au delà, le nombre est déterminé avec le client. <br> Les photos artistiques sont à l’unité.
        </p>
    </div>
</main>
