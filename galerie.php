...
//le code divise les données des galeries en paires à l’aide de array_chunk. 
// Chaque paire est ensuite stockée dans les variables $galeriesLeft et $galeriesRight.
        ...
        ?>
            <div class="row mainGalerie">
                ...
                <div class="col-12 col-md-6 pt-4" data-aos="zoom-in-left">
                    ...
                    <!-- (AOS) est une bibliothèque JavaScript légère qui permet des animations époustouflantes -->
